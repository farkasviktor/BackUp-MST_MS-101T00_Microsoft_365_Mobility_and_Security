...
6. On the **Select type** page of the Payload wizard, the **Email** option should be selected by default (if not, select it now). Select **Next**. 

7. On the **Select Technique** page, select the **Drive-by URL** option. Under this option, select the **View details of Drive-by URL** link. This opens a **Drive-by URL** pane on the right. Review the **Description** and the **Simulation steps** for this type of attack. When you're done, close the **Drive-by URL** pane and select **Next**. 
...
10. On the **Configure Payload** page, enter the following information: <br/>
	...
	- Select a URL you want to be your phishing link: select the **Select URL** button. In the **Select URL for Phishing link** pane, note the list of fictitious URLs. To narrow your choice, enter **prize** in the Search box, select **https://www.prizegives.com** from the list, and then select **Confirm**.
	- Theme: **Personalized Offer**
	- Industry: **Retail**
	- Current Event: **Yes**
	- Select the language for payload : **English** 
	- Email message: Enter the following text that will be displayed in the body of the email message: **Tailspin Toys is offering you a FREE, one-time only giveaway of a toy of your choice as part of our 25th anniversary celebration! Please click on the following link to select the FREE toy of your choice: ** 
...
12. On the **Add Indicators** page, select **Add Indicator**.
...
16. In the **Indicator Description** field, replace the default description with the following text: **Free gifts or other one-time only promotional giveaways**.
...
18. Select the **Add** button at the bottom of the **Add Indicator** pane.
...
21. On the **Attack simulation training** page, select the **Simulations** tab, and then select **+Launch a simulation** that appears on the menu bar.

22. On the **Select Technique** page, select the **Drive-by URL** option and then select **Next**. 

23. On the **Name Simulation** page, enter **Custom payload** in the **Simulation name** field and then select **Next**.

24. On the **Select payload and login page**, select the checkbox for the **Free gift offer** payload that you just created and then select **Next**.
...
28. On the **Exclude users** page, you won't be excluding any users, so select **Next**.
...
30. On the **Select Phish landing page** window, you can select an email template from the various Microsoft templates. In the prior lab exercise, you reviewed already these templates. You can use the same template that you used in the prior attack simulation, or you can select a different template for this simulation. Once you've selected the checkbox for a template, select **Next**.

31. On the **Select end user notification** page, choose how you want the end user to be notified. For the purpose of this lab, select **Microsoft default notification (recommended)**. In the list of notifications that appears, configure the following notifications:
...
33. On the **Launch Details** page, select the **Launch this simulation as soon as I'm done** option and then select **Next**.

34. On the **Review Simulation** page, review the entered information. If anything needs to be changed, select the appropriate **Edit** option to make the change. Once everything is correct, select **Submit**. It may take a few minutes before you receive a confirmation stating **Simulation has been scheduled for launch**. Select **Done**.
