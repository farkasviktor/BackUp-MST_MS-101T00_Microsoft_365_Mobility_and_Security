...
2. In your **Edge** browser, the **Microsoft Intune admin center** should still be open in the **Devices - Microsoft Intune admin center** tab. Select this tab.

3. In the **Microsoft Intune admin center**, in the left-hand navigation pane, select **Devices**.

4. In the **Devices | Overview** window, in the middle navigation pane, select **All devices**.
...
5. In your **Edge** browser, select the **Azure Active Directory** tab. If this tab was previously closed, then in the **Microsoft 365 admin center**, under the **Admin centers** group, select **Azure Active Directory**. This returns the **Microsoft Entra admin center**.

6. In the **Microsoft Entra admin center**, in the left-hand navigation pane, select **Devices**, and then select **Overview**.

7. In the **Devices | Overview** page, in the middle navigation pane, select **All devices**.
